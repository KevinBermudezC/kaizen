...
export function Header() {
  ...
  useEffect(() => {
    // Verificar el tema actual del sistema
        ...
        <div className="grid grid-cols-4 h-16 items-center">
          ...
          <div className="flex items-center justify-end space-x-3">
            ...
            <motion.div 
              ...
              transition={{ type: "spring", stiffness: 300, damping: 15 }}
            >
              <Button className="bg-primary hover:bg-primary/90 text-primary-foreground transition-all duration-200 hover:shadow-lg">
                Acceso Gratuito
              </Button>
            </motion.div>
          </div>
